 ...
 * @LastEditTime: 2023-11-28 09:01:29
 */
...
INSTANTIATE_TEST_CASE_P(Mapping, FusionMappingParam,
  ::testing::Values(
    ...
    "../../../../../Dataset/SLAM_Dataset/fusion_mapping/data10",
    "../../../../../Dataset/SLAM_Dataset/fusion_mapping/data11",
    "../../../../../Dataset/SLAM_Dataset/fusion_mapping/data12",
    "../../../../../Dataset/SLAM_Dataset/fusion_mapping/data13"
  )
);
