 ...
 * @LastEditTime: 2023-11-18 11:12:29
 * @Author: lcfc-desktop
 */
#pragma once
...
class LocationInterface {
 ...
 public:
  explicit LocationInterface(const LocationConfig& config) {
    location_config_ = config;
    display_location_result_ = std::make_shared<
