...
typedef struct ReadMappingAndConfig {
  ...
  XPACK(O(node_name, sub_odom_topic, sub_radar_topic, sub_imu_topic,
        ...
        sub_calibration_cmd_topic, ad_state_topic,
        ad_pose_topic, map_data_file_path,
        map_config_file_path, init_pose_file_path,
        log_file_name, log_level, is_printf_to_terminal,
        mapping_type, location_type, mapping_pattern, odom_type,
        mapping_resolution, flush_odom_list_size, distance_step, angular_step,
        mapping_start_angle, mapping_end_angle, mapping_laser_resolution,
        mapping_laser_min_range, mapping_laser_max_range, location_start_angle,
        location_end_angle, location_laser_resolution,
        ...
        distance_for_same_reflector,
        data_association_max_dis, observation_error,
        map_ma_match_dis_threshold, add_new_center_min_dis,
        reflector_max_distance, distance_diff_threshold,
        error_threshold_for_loop,
        radar_position_x, radar_position_y, radar_position_theta,
        camera_position_x, camera_position_y, camera_position_theta,
